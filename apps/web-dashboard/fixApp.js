...
;
code = code.replace(/  const handleSaveCity = async \(city: CityConfig\) => \{/, savePartnerCode + '\n  const handleSaveCity = async (city: CityConfig) => {');
...
code = code.replace(/<\/td>\s*<td style=\{\{ padding: '16px 20px' \}\}>\s*<span style=\{\{ backgroundColor: c\.auditScore/, parceirosTd + "\n                    <td style={{ padding: '16px 20px' }}>\n                      <span style={{ backgroundColor: c.auditScore");
