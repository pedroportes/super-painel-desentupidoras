...
const projectName = 'desentupidora-ilheus';
const deployUrl = 'https://desentupidora-ilheus.pages.dev';

console.log('🚀 Deploying Ilhéus to Cloudflare Pages...');
...
const idx = cities.findIndex(c => c.id === 'ilheus');
if (idx >= 0) {
...
// Step 3: Build Astro with final deployUrl
...
console.log(`✅ Ilhéus successfully deployed to: ${deployUrl}`);
